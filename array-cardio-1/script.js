...
const firstToLast = inventors.sort((a, b) => a.year - b.year);
console.table(firstToLast);
...
// 7. sort Exercise
const everyone = people.sort((lastOne, nextOne) => {
...
const data = ['car', 'car', 'truck', 'truck', 'pogo', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck' ];

const transport = data.reduce(function(thing, item) {
  if (!thing[item]) {
    thing[item] = 0;
  }
  thing[item]++;
